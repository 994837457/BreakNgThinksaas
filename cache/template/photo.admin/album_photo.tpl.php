...
<?php } ?>
</a></td><td><?php echo $item['albumid'];?></td><td><?php echo $item['userid'];?></td><td><a href="<?php echo SITE_URL;?>index.php?app=photo&ac=admin&mg=album&ts=face&photoid=<?php echo $item['photoid'];?>">设为封面</a> <a href="">修改</a> <a href="<?php echo SITE_URL;?>index.php?app=photo&ac=admin&mg=album&ts=del_photo&photoid=<?php echo $item['photoid'];?>">删除</a></td></tr>
<?php }?>
</table>
</div>
