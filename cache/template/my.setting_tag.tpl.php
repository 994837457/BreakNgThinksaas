...
<div class="clear"></div>
<div style="height:30px;"></div>
<p><a class="btn btn-default btn-sm mt" href="javascript:void('0');" onclick="showTagFrom()"style="margin-top: 10px;">添加标签</a></p>
<div id="tagFrom" style="display:none">
<p ><input class="form-control " type="text" name="tags" id="tags" /></p>
<p>
<button type="submit" class="btn btn-success" onClick="savaTag()" >添加</button> <a href="javascript:void(0);" onClick="showTagFrom()" >取消</a>
</p>
</div>
</div>
</div>
...
/*提交标签*/
function savaTag(){
var userid = "<?php echo $strUser['userid'];?>";
var tag = $('#tags').val();
