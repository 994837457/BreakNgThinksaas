...
$msg_content = '恭喜你，你申请的文化《'.$strGroup['groupname'].'》审核通过！快去看看吧<br />'.tsUrl('group','show',array('id'=>$groupid));
...
$msg_userid = '0';
$msg_touserid = $strGroup['userid'];
$msg_content = '恭喜你，你的文化《'.$strGroup['groupname'].'》被推荐啦！快去看看吧<br />'.tsUrl('group','show',array('id'=>$groupid));
aac('message')->sendmsg($msg_userid,$msg_touserid,$msg_content);
}else{
